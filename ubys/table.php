...
<body id="page-top">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Öğretmen İşlemler </h3>
                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#ekle">Yeni Öğretmen</button>
                    <br>
                    <br>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><img class="rounded-circle mr-2" width="30" height="30" src="assets/img/avatars/teacher.jpg"><?php echo $sonuc['hoca_isim'] ?></td>
                                                <td><?php echo $sonuc['hoca_mail'] ?></td>
                                                <td><?php echo $sonuc['hoca_tarih'] ?></td>
                                                <td>
                                                    <button class="btn btn-default" type="button" data-toggle="modal" data-target="#hoca_duzenle<?= $sonuc['hoca_id'] ?>" href="#hoca_duzenle<?= $sonuc['hoca_id'] ?>"><em class="fa fa-pencil"></em></button>
                                                    <a href="h_sil.php?hoca_id=<?= $sonuc["hoca_id"] ?>"><button class="btn btn-danger" type="button"><em class="fa fa-trash"></em></button></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="exampleModalLabel">Öğretmen Ekleme Sayfası</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="hoca_ekle.php" method="POST">

                                <label>Öğretmen İsim:</label>
                                <input class="form-control" type="text" class="field left" name="hoca_isim" required>
                                <br>
                                <label>Mail:</label>
                                <input class="form-control" type="mail" value="" name="hoca_mail" required>
                                <br>
                                <label>Password:</label>
                                <input class="form-control" type="password" name="hoca_sifre" required>
                                <br>
                                <label>Doğum Tarihi:</label>
                                <input class="form-control" type="date" value="" name="hoca_tarih" required>
                                <br>

                                <a href="hoca_ekle.php"><button type="submit" class="btn btn-success ">Ekle</button></a>
    ...
    ?>
    <!-- DÜZENLE Modal -->
    <div class="modal fade" id="hoca_duzenle<?= $sonuc['hoca_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel">Öğretmen Düzenleme</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <form action="h_duzenle.php?hoca_id=<?= $sonuc["hoca_id"] ?>" method="POST">

                            <label>Ad-Soyad:</label>
                            <input class="form-control" type="text" class="field left" value="<?php echo $sonuc['hoca_isim']; ?>" name="hoca_isim" required readonly>
                            <br>
                            <label>Mail:</label>
                                <input class="form-control" type="mail" value="<?php echo $sonuc['hoca_mail']; ?>" name="hoca_mail" required>
                                <br>
                                <label>Password:</label>
                                <input class="form-control" type="password" value="<?php echo $sonuc['hoca_sifre']; ?>" name="hoca_sifre" readonly>
                                <br>
                                <label>Doğum Tarihi:</label>
                                <input class="form-control" type="date" value="<?php echo $sonuc['hoca_tarih']; ?>" name="hoca_tarih" required>
                            <br>

                            <a href="h_duzenle.php?hoca_id=<?= $sonuc["hoca_id"] ?>"><button type="submit" class="btn btn-success ">Düzenle</button></a>
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Kapat</button>
                        </form>
