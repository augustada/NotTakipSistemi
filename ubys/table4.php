        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Ders Seçimleri </h3>
                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#ekle">Seçim Ekle</button>
                    <br>
                    <br>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <?php 
                                        include "baglan.php";
                                        $sorgu = $baglan->prepare("SELECT * FROM ogrenci JOIN ders_secim ON ogrenci.id=ders_secim.ogrenci_id JOIN ders ON ders.ders_id=ders_secim.ders_id order by secim_id");
                                        $sorgu->execute();
                                        while ($sonuc = $sorgu->fetch(PDO::FETCH_ASSOC)) {
                                        ?>
                                        <tr>
                                            <td><img class="rounded-circle mr-2" width="30" height="30" src="asset/img/avatars/comments.png"><?php echo $sonuc['secim_id'] ?></td>
                                            <td><?php echo $sonuc['username'] ?></td>
                                            <td><?php echo $sonuc['ders_adi'] ?></td>
                                            <td>
                                            
                                                        <a href="secim_sil.php?secim_id=<?= $sonuc['secim_id'] ?>"><button class="btn btn-danger" type="button" ><em class="fa fa-trash"></em></button></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <td><strong>Seçim ID</strong></td>
                                            <td><strong>Öğrenci İsim</strong></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="ogrenci_ekle2.php" method="POST">
                        ...
                        <a href="ogrenci_ekle2.php?"><button type="submit" class="btn btn-success ">Ekle</button></a>
