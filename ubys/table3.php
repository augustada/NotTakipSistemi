...
<body id="page-top">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Duyurular </h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Announcements Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><img class="rounded-circle mr-2" width="30" height="30" src="asset/img/avatars/comments.png"><?php echo $sonuc['hoca_isim'] ?></td>
                                            <td><a href=<?php echo ("activate.php?duyuru_id=" . ($sonuc["duyuru_id"]) . "&duyuru_durum=" . ($sonuc["duyuru_durum"] == 0)) ?>><?php echo ($sonuc["duyuru_durum"] == 0 ? "Aktif Değil" : "Aktif"); ?></a></td>
                                            ...
                                            <button class="btn btn-default" type="button" data-toggle="modal" data-target="#duyuru_duzenle<?= $sonuc['duyuru_id'] ?>" href="#duyuru_duzenle<?= $sonuc['duyuru_id'] ?>"><em class="fa fa-pencil"></em></button>
                                                        <a href="d_sil.php?duyuru_id=<?= $sonuc["duyuru_id"] ?>"><button class="btn btn-danger" type="button"><em class="fa fa-trash"></em></button></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="ekle.php" method="POST">
                            ...
                            <br>
                            <label>Sınıf:</label>
                            <input class="form-control" type="text" value="" name="sınıf" required>
                            <br>
                            <label>Dönem:</label>
    ...
    ?>
    <!-- DÜZENLE Modal -->
    <div class="modal fade" id="duyuru_duzenle<?= $sonuc['duyuru_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="d_duzenle.php?duyuru_id=<?= $sonuc["duyuru_id"] ?>" method="POST">
                            ...
                            <a href="d_duzenle.php?duyuru_id=<?= $sonuc["duyuru_id"] ?>"><button type="submit" class="btn btn-success ">Düzenle</button></a>
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Kapat</button>
                        </form>
